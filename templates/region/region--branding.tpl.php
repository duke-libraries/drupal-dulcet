<div<?php print $attributes; ?>>
  <div<?php print $content_attributes; ?>>
    ...
    <div class="branding-data clearfix">
      ...
      <div class="logo-img">
        <a onClick="ga('send', 'event', { eventCategory: 'Header', eventAction: 'Branding', eventLabel: 'Library Logo'});" href="//library.duke.edu"><img src="/sites/all/themes/madlib/logo.png" alt="Duke University Libraries" id="logo"></a>
      </div>
      <?php endif; ?>
