...
<<?php print $tag; ?><?php print $attributes; ?>>
  <div class="block-inner clearfix">
    ...
    <div class="shaded-column-left" <?php print $content_attributes; ?>>
      ...
      <!-- content above menu -->
            <p class="sidebar-logo"><a href="/research/humanities"><img src="<?php print base_path(); ?>sites/default/files/dul/humanities/humanities_logo.jpg" class="img-polaroid" alt="image" width="155"></a></p><ul class="nav nav-list"><li class="nav-header nav-header-gray"><a href="/research/humanities">Humanities Research</a></li></ul>
        <!-- / content above menu -->
