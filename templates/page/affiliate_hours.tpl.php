<?php
/**
 * Empty template file that can contain links to affiliate libraries
 * (Ford, Medical Center, etc)
 *
 * To customize, copy to your theme's directory and modify it.
 */
?>
...
<!-- <section aria-labelledby="visiting"> -->
	...
	<p class="lead">During the Coronavirus response, access to Duke Libraries is limited to members of the Duke University community who will need to swipe their DukeCard of Mobile DukeCard to enter buildings.</p>
	<p>All other visitors &mdash; including TRLN users, Friends of the Libraries, Duke alumni, non-affiliated researchers, and the general public &mdash; <strong>will not have access</strong> until campus restrictions are lifted by the university.</p>
	-->
